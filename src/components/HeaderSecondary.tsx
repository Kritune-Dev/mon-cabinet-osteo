  ...
  return (
    <>
      ...
      >
        ...
        <div
          id="header-secondary-background"
        ...
        >
          ...
          {/* Banner à droite, centrée verticalement (desktop uniquement) */}
          {bannerConfig.show && (
            <div className="hidden md:flex flex-shrink-0 mr-4 sm:mr-8">
      ...
      {/* Banner mobile : juste sous le header secondary */}
      {bannerConfig.show && (
        <div className="block md:hidden w-full bg-[#F1DFD6] border-t border-[#E8D5CC] text-[#543C30] px-4 py-2 text-center font-semibold shadow">
          {bannerConfig.message}
        </div>
      )}
    </>
